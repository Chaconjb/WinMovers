...
namespace WinMovers.Migrations
{
    ...
    [Migration("20260805194549_AgregarListasEmbalaje")]
    partial class AgregarListasEmbalaje
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WinMovers.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("clave_autenticador")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("clave_autenticador");
            ...
            modelBuilder.Entity("WinMovers.Models.BienMudanza", b =>
                {
                    ...
                    b.HasIndex("IdOrden", "NombreBien")
                        .IsUnique()
                        .HasDatabaseName("UX_BienesMudanza_Orden_Nombre");

                    b.ToTable("BienesMudanza", (string)null);
                });
            ...
            modelBuilder.Entity("WinMovers.Models.Inventario", b =>
                {
            ...
            modelBuilder.Entity("WinMovers.Models.OrdenTrabajoMaterial", b =>
                {
                    b.Property<int>("IdOrdenMaterial")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id_orden_material");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdOrdenMaterial"));
                    ...
                    b.HasKey("IdOrdenMaterial");

                    b.HasIndex("IdMaterial");

                    b.HasIndex("IdOrden");

                    b.ToTable("OrdenTrabajoMaterial", (string)null);
                });
            ...
            modelBuilder.Entity("WinMovers.Models.OrdenTrabajoMaterial", b =>
                {
                    b.HasOne("WinMovers.Models.Inventario", "Material")
                        .WithMany("OrdenesMaterial")
                        .HasForeignKey("IdMaterial")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WinMovers.Models.OrdenTrabajo", "OrdenTrabajo")
                        .WithMany("MaterialesAsignados")
                        .HasForeignKey("IdOrden")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
